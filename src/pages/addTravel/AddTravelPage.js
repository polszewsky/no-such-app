...
export default function AddTravelPage() {
  return <Grid container spacing={5} direction="column" alignItems="center" justifyContent="center">
    <h1 alignItems="center" style={{ marginTop: 50 }}>Add next travel</h1>
    <Grid justifyContent="center" item xs={12} sx={{ display: 'flex', alignItems: 'flex-end' }}>
        <DirectionsCarIcon sx={{mr: 1, my: 0.5 }} />
        <TextField variant="standard" label="Typ pojazdu" style={{marginRight: 5}} startIcon={<DirectionsCarIcon />}/>
    </Grid>
    <Grid justifyContent="center" item xs={12} sx={{ display: 'flex', alignItems: 'flex-end' }}>
        <GarageIcon sx={{mr: 1, my: 0.5 }}/>
        <TextField variant="standard" label="Twoje pojazdy" style={{marginRight: 5}}/>
    </Grid>
    <Grid justifyContent="center" item xs={12} sx={{ display: 'flex', alignItems: 'flex-end' }}>
        <GarageIcon sx={{mr: 1, my: 0.5 }}/>
        <TextField variant="standard" label="Średnie spalanie" style={{marginRight: 5}}/>
    </Grid>
    <Grid justifyContent="center" item xs={12} sx={{ display: 'flex', alignItems: 'flex-end' }}>
        <StartIcon sx={{mr: 1, my: 0.5 }}/>
        <TextField variant="standard" label="Lokacja startowa" style={{marginRight: 5}}/>
    </Grid>
    <Grid justifyContent="center" item xs={12} sx={{ display: 'flex', alignItems: 'flex-end' }}>
        <SportsScoreIcon sx={{mr: 1, my: 0.5 }}/>
        <TextField variant="standard" label="Lokacja końcowa" style={{marginRight: 5}}/>
    </Grid>
